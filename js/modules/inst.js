    ...
    displayInitialInstruction(funcParams, nextFunc, nextParams) {
        ...
        let text = {
            1: ` • This experiment is composed of 3 main steps. \n\n
                 • The first step is a training phase consisting of 3 different cognitive tests.\n\n
            ...
            2: ` • In addition to the fixed compensation provided by Prolific, you have been endowed with an additional 2.5 pounds. \n\n
                 ...
                 • Across the three phases of the experiment, you can win a bonus up to ${this.exp.maxPoints} points = ${this.exp.pointsToPounds(this.exp.maxPoints).toFixed(2)} pounds!`,
    ...
    displayInstructionLearning(funcParams, nextFunc, nextParams) {
        ...
        let text = {
           ...
           ${GUI.panelGenerateImg({ src: 'images/instructions/2.png', width: '40%' })}`,
            2: ` • The different symbols are not equal in terms of outcome (and more precisely, in terms of odds of winning or losing/winning): in a given pair, one is, on average, more advantageous compared to the other. \n
        ...
        if (isTraining) {
            text = {
              1: ` • In each round you have to choose between one of two items displayed on either side of the screen. \n
                   ...
                   • Please note that in this test, <b>no outcome will be displayed</b>, such that after a choice, the next pair of options will be shown without an intermediate step.\n
                   • At the end of the test, you will be shown the final payoff in terms of cumulative points and monetary bonus.`,
              2: ` • In the second test, there will be two kinds of options. \n
                   • The first kind of options is represented by the symbols you already encountered during the previous test.\n
                   ...
                   • The second kind of options is represented by pie-charts that explicitly describe the odds of winning/losing a point.\n
                   ${GUI.panelGenerateImg({ src: 'images/cards_gif/lotteries/0.png', width: '15%' })}
                   Specifically, the green area indicates the chance of winning +1 (+'${this.exp.pointsToPence(1).toFixed(2)}p) ; the red area indicates the chance of losing -1 (-${this.exp.pointsToPence(1).toFixed(2)}p).\n
                   Pie-charts range from 100% chance of winning a point to 100% chance of losing a point.\n\n
                   • Sometimes you will be asked to choose between two symbols, a pie-chart and a symbol, and sometimes between two pie-charts.`,
              3: ` • (Note: points won during the training do not count towards the final payoff!) \n\n
